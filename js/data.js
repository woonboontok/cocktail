...
const DEFAULT_INVENTORY = [
  ...
  { id: "kahlua", name: "Kahlúa Coffee Liqueur", category: "liqueurs", subCategory: "Coffee", inStock: true, notes: "Mexican Arabica coffee and sugarcane rum liqueur for White Russian and B-52." },
  { id: "walcher-coffee", name: "Walcher Premium Coffee Liqueur", category: "liqueurs", subCategory: "Coffee", inStock: true, notes: "Artisanal South Tyrol organic coffee liqueur with deep espresso roast." },
  { id: "cointreau", name: "Cointreau", category: "liqueurs", subCategory: "Citrus & Orange", inStock: true, notes: "Premier French 40% ABV crystal triple sec. Essential for Margarita and Sidecar." },
  { id: "grand-marnier", name: "Grand Marnier", category: "liqueurs", subCategory: "Citrus & Orange", inStock: true, notes: "Cognac-based bitter orange liqueur. Adds luxury to B-52 and Cadillac Margarita." },
  { id: "lumina-triple-sec", name: "Lumina Triple Sec Liqueur", category: "liqueurs", subCategory: "Citrus & Orange", inStock: true, notes: "Sweet citrus liqueur ideal for Kamikaze and highball mixing." },
  { id: "curacao-bleu", name: "Curaçao Bleu Liqueur (élaboré en France)", category: "liqueurs", subCategory: "Citrus & Orange", inStock: true, notes: "Electric blue orange liqueur for Blue Lagoon and Blue Kamikaze." },
  { id: "hoffmann-peach", name: "Hoffmann Peach Liqueur", category: "liqueurs", subCategory: "Fruit & Floral", inStock: true, notes: "Juicy ripe peach schnapps for Sex on the Beach and Woo Woo." },
  { id: "cherry-heering", name: "Peter Heering Cherry Liqueur", category: "liqueurs", subCategory: "Fruit & Floral", inStock: true, notes: "Danish ruby cherry liqueur since 1818. Backbone of Singapore Sling and Blood and Sand." },
  { id: "st-germain", name: "St-Germain Elderflower Liqueur", category: "liqueurs", subCategory: "Fruit & Floral", inStock: true, notes: "Handpicked wild elderflowers with lychee, pear, and grapefruit notes. Key for Hugo Spritz." },
  ...
  { id: "creme-de-mure", name: "Crème de Mûre (Blackberry)", category: "liqueurs", subCategory: "Fruit & Floral", inStock: false, notes: "Blackberry liqueur drizzled on the Bramble." },
  ...
  { id: "absinthe", name: "Absinthe", category: "liqueurs", subCategory: "Anise & Herbal", inStock: false, notes: "Aromatic anise rinse for Sazerac and Corpse Reviver No. 2." },
  { id: "tequila-rose", name: "Tequila Rose Strawberry Cream Liqueur", category: "liqueurs", subCategory: "Cream Liqueurs", inStock: false, notes: "Strawberry cream and Mexican tequila liqueur for Tequila Rose Shot." },
  { id: "frangelico", name: "Frangelico Hazelnut Liqueur", category: "liqueurs", subCategory: "Nut & Spice", inStock: false, notes: "Hazelnut liqueur for Nutty Irishman and Duck Fart." },

  // --- FORTIFIED WINES & APERITIFS (User In Stock) ---
  { id: "lillet-blanc", name: "Lillet Blanc", category: "fortified", subCategory: "Fortified Wine", inStock: true, notes: "French wine aperitif with candied orange and honey for Vesper and Corpse Reviver No. 2." },
  { id: "martini-extra-dry", name: "Martini Extra Dry Vermouth", category: "fortified", subCategory: "Vermouth", inStock: true, notes: "Crisp dry Italian vermouth scented with Florentine Orris for Dry Martini." },
  { id: "martini-rosso", name: "Martini Rosso Red Vermouth", category: "fortified", subCategory: "Vermouth", inStock: true, notes: "Sweet Italian red vermouth for Negroni, Manhattan, Boulevardier, and Americano." },
  { id: "aperol", name: "Aperol", category: "fortified", subCategory: "Aperitifs / Bitters", inStock: true, notes: "Bittersweet orange, rhubarb, and gentian aperitivo for Aperol Spritz and Paper Plane." },
  { id: "campari", name: "Campari", category: "fortified", subCategory: "Aperitifs / Bitters", inStock: true, notes: "Iconic red bitter aperitif with chinotto citrus and herbs for Negroni and Boulevardier." },
  { id: "amaro-nonino", name: "Amaro Nonino Quintessentia", category: "fortified", subCategory: "Amaro", inStock: false, notes: "Grappa-based alpine amaro for Paper Plane." },

  // --- SPARKLING WINE (User In Stock) ---
  { id: "gio-prosecco", name: "Gio Prosecco Spumante Extra Dry", category: "sparkling", subCategory: "Sparkling Wine", inStock: true, notes: "Crisp Italian Prosecco with fine bubbles for Aperol Spritz, French 75, Bellini, and Mimosa." },
  ...
  { id: "fresh-mint", name: "Fresh Spearmint", category: "fresh_garnishes", subCategory: "Fresh Citrus & Herbs", inStock: false, notes: "Aromatic sprigs for Mojito, Mint Julep, and Hugo Spritz." },
  ...
  { id: "coarse-salt", name: "Coarse Kosher Salt", category: "fresh_garnishes", subCategory: "Garnishes", inStock: false, notes: "For glass rims on Margarita, Paloma, and Salty Dog." },
  { id: "ice", name: "Quality Ice (Cubes & Crushed)", category: "fresh_garnishes", subCategory: "Bar Essentials", inStock: false, notes: "The foundation of temperature and dilution for every drink." }
];
